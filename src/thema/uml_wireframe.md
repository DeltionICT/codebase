...
<img src="{{ '/_assets/themas/Wireframe-example.png' | url }}" style="width:40%;"> 
<img src="{{ '/_assets/themas/wireframe.png' | url }}" style="width:30%;"> 
<img src="{{ '/_assets/themas/wireframes_app-process.jpg' | url }}" style="width:25%;">
...
Details over Wireframes zijn te vinden op how to: [WireFrames]({{ 'https://www.lucidchart.com/pages/how-to-make-a-wireframe' | url }})
en [WireFrames explained]({{ 'https://www.lucidchart.com/pages/wireframe' | url }}).
