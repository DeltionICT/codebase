...
<img src="{{ '/_assets/themas/activitydiagram.png' | url }}" style="width:22%;"> 
<img src="{{ '/_assets/themas/activitydiagram-banking.png' | url }}" style="width:40%;">
...
Details over ActiviteitenDiagrammen zijn te vinden op how to: [ActivityDiagram]({{ 'https://www.lucidchart.com/pages/how-to-draw-an-activity-diagram-in-UML' | url }}) en 
[ActivityDiagram explained]({{ 'https://www.lucidchart.com/pages/uml-activity-diagram' | url }}).
